...
def main() -> None:
    ...
    parser.add_argument("--batch-size", type=int, default=None, help="Mini-batch size (default: full dataset). Smaller batches add gradient noise that improves grokking reliability.")
